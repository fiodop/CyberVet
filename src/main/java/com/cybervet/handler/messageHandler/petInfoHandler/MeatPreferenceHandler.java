...
@HandlerForState(UserState.CHOOSING_MEAT)
public class MeatPreferenceHandler implements MessageHandler {
    ...
    public ArrayList<ResponseDto> handle(long chatId, String message) {
        ...
        ResponseDto responseDto = new ResponseDto(chatId, "Выберите предпочитаемый источник мяса:");
        responseDto.setReplyKeyboardMarkup(replyKeyboardService.getMeatTypeKeyboard());
